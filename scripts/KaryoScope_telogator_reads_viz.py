...
def parse_args():
    ...
    parser.add_argument(
        "--title",
        default="Telomeric Reads Region Feature Visualization",
        help="Plot title (default: 'Telomeric Reads Region Feature Visualization')",
    )
    parser.add_argument(
        "--log-file",
        dest="log_file",
...
def main():
    ...
    print("=" * 60)
    print("KaryoScope Telogator Reads Visualization")
    print("=" * 60)
